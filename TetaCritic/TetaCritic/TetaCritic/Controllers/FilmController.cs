...
namespace TetaCritic.Controllers
{
    public class FilmController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FilmId,Yonetmen,Ozet,VizyonTarihi,KategoriId")] Film film)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FilmId,Yonetmen,Ozet,VizyonTarihi,KategoriId")] Film film)
        {
            if (id != film.FilmId)
            {
                return NotFound();
